...
@PageAccessor(name = "Set a Goal", url = "/user/reading_challenge_reg")
public class SetGoal extends AbstractPage {

    @Timeout(BIG_WAIT_TIMEOUT)
    @FindBy(xpath = "//h1[normalize-space()='Set a Reading Goal!']")
    ...
    public SetGoal(WebDriver driver, String url, String name) {
        super(driver, url, name);
    }

    public SetGoal(WebDriver driver) {
        super(driver);
    }
